...
const API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDRFRThjRDc3MTA4ZGIzNzE0RkY0OTU2NTY1REJDODM2NDRGNkZkYmIiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2NjEwNzkyNTIxNTgsIm5hbWUiOiJ1bmNoYWluIn0.4QG_Ru_efwVejbs1RMlbPOgEcOnEdjw4V3b6zq501Z0";
const NftUploader = () => {
  /*
  ...
  const checkIfWalletIsConnected = async () => {
    ...
    // 0x4 は　Rinkeby の ID です。Goerliは0x5
  ...
  const askContractToMintNft = async (ipfs) => {
    const CONTRACT_ADDRESS =
      "0xF5b547364d926Db184B27B63D9592fcAf8325680";
    try {
      const { ethereum } = window;
      if (ethereum) {
